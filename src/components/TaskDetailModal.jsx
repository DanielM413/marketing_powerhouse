...
import { Calendar, CheckSquare, Clock, ArrowRight, User, ExternalLink, Globe, Edit2, Save, X, FileText, Trash2, Sparkles, RefreshCw, Play, MessageSquare } from 'lucide-react';
            ...
            <div className="modal animate-in" onClick={e => e.stopPropagation()} style={{
                ...
                <div className="modal-footer" style={{ background: 'var(--bg-surface)' }}>
                    {isEditing ? (
                        ...
                        <a href={`/campaigns/${task.campaignId}`} className="btn btn-primary w-full" style={{ justifyContent: 'center' }}>
