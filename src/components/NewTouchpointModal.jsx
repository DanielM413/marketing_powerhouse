...
export default function NewTouchpointModal({ onClose, onCreate }) {
                    ...
                    <div className="card" style={{ marginBottom: '16px', borderLeft: '4px solid var(--color-primary)' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                            ...
                            <div className="form-group">
                                ...
                                <select className="form-select" value={newTp.status} onChange={e => setNewTp({ ...newTp, status: e.target.value })}>
                            ...
                            <div className="form-group">
                                ...
                                <select className="form-select" value={newTp.journeyPhase || ''} onChange={e => setNewTp({ ...newTp, journeyPhase: e.target.value || null })}>
